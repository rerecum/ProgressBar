    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.sort).setOnClickListener {
            ...
            val ListLength = if (findViewById<EditText>(R.id.numbers).text.toString()!="")
                ...
                val listSorted: List<Int> =
                    sortWithProgress(ListToSort, findViewById(R.id.progressBar))
                runOnUiThread {
                    findViewById<TextView>(R.id.time).text =
                        "Czas sortowania: ${"%.2f".format((System.currentTimeMillis() - currentTime).toDouble() / 1000)} sekund"
                }
